First project within the Odin Project, recreating a webpage by using developer tools from within Firefox browser. This is a project focusing on HTML & CSS. 
